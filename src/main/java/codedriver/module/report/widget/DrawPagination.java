        ...
        if (needPage) {
            ...
            if (arguments.size() == 2 && arguments.get(0) != null) {
                try {
                    ...
                    if (pageObj.getIntValue("currentPage") > 0) {
                        currentPage = 38;// pageObj.getIntValue("currentPage");
                    }
            ...
            if (canReturn) {
                ...
                if (currentPage <= 1) {
                    ...
                    str +="<li title=\"上一页\" class=\"ivu-page-prev\"><a><i class=\"ivu-icon ivu-icon-ios-arrow-back\"></i></a></li>" ;
                }
                //第一页
                if(currentPage >= 1) {
                    if(currentPage ==1) {
                        ...
                        str += "<li title=\"1\" class=\"ivu-page-item\"><a>1</a></li>";
                    }
                }
                //向前五页
                if (currentPage >5) {
                    str += "<li title=\"向前 5 页\" class=\"ivu-page-item-jump-prev\"><a><i class=\"ivu-icon ivu-icon-ios-arrow-back\"></i></a></li>";
                }
                ...
                for (int k = startPage; k <= currentPage; k++) {
                    if (currentPage == k) {
                        ...
                        str += "<li title=\"1\" class=\"ivu-page-item \"><a>"+k+"</a></li>";
                    }
                }
                //nextPages
                if(pageCount - 4 > currentPage) {
                    ...
                    str += "<li title=\"向后 5 页\" class=\"ivu-page-item-jump-next\"><a><i class=\"ivu-icon ivu-icon-ios-arrow-forward\"></i></a></li>";
                    str += "<li title=\""+pageCount+"\" class=\"ivu-page-item\"><a>"+pageCount+"</a></li> ";
                }else {
                    for (int k = pageCount; k > currentPage; k--) {
                        if (currentPage == k) {
                            str += "<li title=\"1\" class=\"ivu-page-item ivu-page-item-active\"><a>"+k+"</a></li>";
                        } else {
                            str += "<li title=\"1\" class=\"ivu-page-item \"><a>"+k+"</a></li>";
                ...
                if (currentPage >= pageCount) {
                    ...
                    str +="<li title=\"下一页\" class=\"ivu-page-next\"><a><i class=\"ivu-icon ivu-icon-ios-arrow-forward\"></i></a></li> ";
                } 
                str += "<div class=\"ivu-page-options\">" + 
                    ...
                    "                         <div class=\"\">" + 
                    "                             <span class=\"ivu-select-selected-value\">20 条/页</span> " + 
