...
public class JfreeChartUtil {
    ...
    * @return
    ...
    public enum ChartColor {
        ...
        // 色板
        COLOR1("color1", "颜色1", 12, new Color(31, 129, 188)),
        COLOR2("color2", "颜色2", 13, new Color(92, 92, 97)),
        COLOR3("color3", "颜色3", 14, new Color(144, 237, 125)),
        COLOR4("color4", "颜色4", 15, new Color(255, 188, 117)),
        COLOR5("color5", "颜色5", 16, new Color(153, 158, 255)),
        COLOR6("color6", "颜色6", 17, new Color(255, 117, 153)),
        COLOR7("color7", "颜色7", 18, new Color(253, 236, 109)),
        COLOR8("color8", "颜色8", 19, new Color(128, 133, 232)),
        COLOR9("color9", "颜色9", 20, new Color(158, 90, 102)),
        COLOR10("color10", "颜色10", 21, new Color(255, 204, 102));
